...
CSCI 311 with a grade of C or higher, MATH 109 or MATH 121. (or approved equivalent, check with your advisor)
...
Once you create an account, log on and enroll in CSCI 551, make sure you enroll in the correct section.

**I WILL DROP YOU FROM THE CLASS IF YOU DO NOT CREATE THIS ACCOUNT**

You will may this system to turn in your programming and lab assignments.
...
Additionally, you can email me directly with any specific questions, the distinction would be help with your code or assignment that would be unique to you and sharing with the class on the discussion board would be considered cheating. Make sure you put **'CSCI551'** in the subject so it will be filtered correctly. **ALL EMAIL WITH NO SUBJECT WILL NOT BE OPENED**, so if you send me an email without a subject do not expect a response as I will not open it or respond to it.
...
I will routinely communicate with the class via announcements on the Piazza board, you will not receive the class e-mails and may miss important information about the class if are unable to access the Piazza board.

Make sure you have a Moodle account, I do not update grades after I initially post them and I use Moodle as my LMS to post your grades.
...
Employers who want to see a coding portfolio want to see code you developed outside of the required code you wrote for courses.
